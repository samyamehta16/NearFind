...
function Businessitem({ business }) {
  ...
  return (
    ...
    border-b-[1px] border-red-300 mb-4 items-center text-[20px]
        font-bold text-red-400"
    >
      <Image
        src={`https://maps.gomaps.pro/maps/api/place/photo?photo_reference=${photo_ref}&maxwidth=400&key=${GOOGLE_API_KEY}`}
        alt="business-image"
        width={90}
        height={90}
